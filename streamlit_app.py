    ...
    def _predict_all(self):
        ...
        for it in analysis:
            ...
            if comb < full_avg and comb > 0:
                ...
                if not declining:
                    comb = full_avg
            # Sigurnosna mreza: predikcija 0 samo ako nista prodato u poslednjih 5 meseci
            if comb <= 0:
...
def create_excel(engine):
    ...
    info=["OPIS MODELA PREDIKCIJE I PORUDZBINE","",f"=== PREDIKCIJA ZA {engine.pred_label.upper()} ===","",
        ...
        "  8. Sigurnosna mreza: predikcija=0 samo ako nista prodato u poslednjih 5 meseci",
